                    ...
                    <div className="bg-gray-50 border border-gray-200 rounded-lg p-6">
                        ...
                        <div className="space-y-4 text-base">
                            ...
                            <div className="flex justify-between items-center py-2 border-t font-semibold">
                                <span className="text-gray-800">Pure Premium (Loss + Volatility):</span>
                                <span className="font-mono text-gray-900 font-bold">{formatCurrency(purePremium)}</span>
                            </div>
                            <div className="flex justify-between items-center py-2 border-t">
                            ...
                            <div className="flex justify-between items-center py-3 mt-2 bg-blue-50 rounded-md px-3">
                                <span className="font-bold text-blue-800 text-lg">Final Gross Premium:</span>
                                <span className="font-mono text-blue-800 font-bold text-lg">{formatCurrency(finalPremium)}</span>
                            </div>
                        </div>
                    </div>
                </main>
